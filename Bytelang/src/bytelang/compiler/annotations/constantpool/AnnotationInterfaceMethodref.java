...
import bytelang.classes.constantpool.CPItemInterfaceMethodref;
...
public class AnnotationInterfaceMethodref extends BasicAnnotation implements Factory<AnnotationInterfaceMethodref>, CPItemAnnotation {
	...
	@Override
	public AnnotationInterfaceMethodref newInstance() {
		return new AnnotationInterfaceMethodref();
	}
	...
	public CPItem toCPItem(ConstantPoolBuilder constantPoolBuilder) {
		...
		return new CPItemInterfaceMethodref(id, classIndex, nameAndTypeIndex);
	}
